...
<script type="es6">
  ...
  import imgLoadBalance from '../../svg/load_balance.svg';
  import imgServer from '../../svg/server.svg';
  import imgSwitch from '../../svg/switch.svg';
  import imgSwitchThree from '../../svg/switch_three.svg';
  import imgSwitchVlan from '../../svg/switch_vlan.svg';
  import imgTriangle from '../../svg/triangle.svg';
  import imgHighdataA from '../../svg/highdata_a.svg';
  import imgHighdataB from '../../svg/highdata_b.svg';
  export default {
    name: 'home',
    beforeCreate (){
