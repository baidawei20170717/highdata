        ...
        <div class="row-base-style is-table-data">
          ...
          <div class="item ">
            <div class="box-header">
              <h3 class="box-title">当天安全告警列表</h3>
            </div>
            <div class="box-body no-padding layer-mb20">
              <table class="table table-condensed">
                ...
                <tr v-for="item in events">
                  <td><router-link style="color:#fff" :to="{name: 'warn_security_single', params: {id: item.ruleId}}">{{item.name}}</router-link></td>
