          ...
          <div class="item ">
            ...
            <div class="box-body no-padding layer-mb20">
              <table class="table table-condensed">
                ...
                <tr>
                  <td><router-link style="color:#fff" to="/warn/security/1">同一服务器3分钟内平均cpu超过80％</router-link></td>
                  <td>性能告警</td>
                  <td>100</td>
                </tr>
...
<script type="es6">
  ...
  export default {
    ...
    return {
      performance_chart: 'security_performance',
      performance_option,
      performanceType_chart: 'security_performanceType',
